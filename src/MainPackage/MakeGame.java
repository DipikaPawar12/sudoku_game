/*
 * This file generates a random sudoku game in the 9X9 field generated.
 */
...
public class MakeGame extends Observable {
    ...
    public static void setSolNumber(int x, int y, int number) {
        solution[y][x] = number;
    }
    /**
    ...
    public static int getSolNumber(int x, int y) {
        return solution[y][x];
    }
    
    public boolean correctSol(){
        for (int y = 0; y < 9; y++) {
            for (int x = 0; x < 9; x++)
